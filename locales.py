...
STRINGS = {
    ...
    "ask_end_time_choice": {
        "en": "Set an end time?\n\n_If skipped, Google Calendar will show 4 hours duration by default._",
        "ru": "Указать время окончания?\n\n_Если пропустить, Google Календарь покажет длительность 4 часа по умолчанию._",
        "el": "Να οριστεί ώρα λήξης;\n\n_Αν παραλειφθεί, το Google Ημερολόγιο θα εμφανίσει διάρκεια 4 ωρών από προεπιλογή._",
        "uk": "Вказати час закінчення?\n\n_Якщо пропустити, Google Календар покаже тривалість 4 години за замовчуванням._",
    },
    "ask_end_time_hour": {
        "en": "End time — pick a period:\n\n_This time applies to all days of the event._",
        "ru": "Время окончания — выберите период:\n\n_Это время применяется ко всем дням события._",
        "el": "Ώρα λήξης — επιλέξτε περίοδο:\n\n_Αυτή η ώρα ισχύει για όλες τις ημέρες της εκδήλωσης._",
        "uk": "Час завершення — оберіть період:\n\n_Цей час застосовується до всіх днів події._",
    },
    "ask_end_time_minute": {
