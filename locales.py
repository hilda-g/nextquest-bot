...
STRINGS = {
    ...
    "step_category": {
        "en": "Step 1/6: *What kind of event is this?*\n\nCan't find yours? Pick 🃏 Other.",
        "ru": "Шаг 1/6: *Что за событие?*\n\nНе нашёл своё? Выбери 🃏 Другое.",
        "el": "Βήμα 1/6: *Τι είδους εκδήλωση είναι αυτή;*\n\nΔεν βρίσκεις; Επίλεξε 🃏 Άλλο.",
        "uk": "Крок 1/6: *Що за подія?*\n\nНе знайшов своє? Обери 🃏 Інше.",
    },
    "ask_event_language": {
        "en": "Step 2/6: *Event language(s)?*\n\nSelect all that apply, then tap Done.",
        "ru": "Шаг 2/6: *Язык(и) события?*\n\nВыбери все подходящие, затем нажми Done.",
        "el": "Βήμα 2/6: *Γλώσσα(-ες) εκδήλωσης;*\n\nΕπίλεξε όλες τις κατάλληλες, μετά πάτα Done.",
        "uk": "Крок 2/6: *Мова(-и) події?*\n\nОбери всі відповідні, потім натисни Done.",
    },
    "step_date_start": {
    ...
    "ask_end_hour": {
        "en": "End time — pick a period:\n\nThis time applies to all days of the event.",
        "ru": "Время окончания — выберите период:\n\nЭто время применяется ко всем дням события.",
        "el": "Ώρα λήξης — επιλέξτε περίοδο:\n\nΑυτή η ώρα ισχύει για όλες τις ημέρες της εκδήλωσης.",
        "uk": "Час завершення — оберіть період:\n\nЦей час застосовується до всіх днів події.",
    },
    "ask_end_minute": {
        "en": "End minutes?",
        "ru": "Минуты окончания?",
    ...
    "ask_end_time_choice": {
        "en": "Set an end time?\n\nIf skipped, Google Calendar will show 4 hours duration by default.",
        "ru": "Указать время окончания?\n\nЕсли пропустить, Google Календарь покажет длительность 4 часа по умолчанию.",
        "el": "Να οριστεί ώρα λήξης;\n\nΑν παραλειφθεί, το Google Ημερολόγιο θα εμφανίσει διάρκεια 4 ωρών από προεπιλογή.",
        "uk": "Вказати час закінчення?\n\nЯкщо пропустити, Google Календар покаже тривалість 4 години за замовчуванням.",
    },
    "ask_end_time_hour": {
        "en": "End time — pick a period:\n\nThis time applies to all days of the event.",
        "ru": "Время окончания — выберите период:\n\nЭто время применяется ко всем дням события.",
    ...
    "ask_end_time_minute": {
        "en": "End time — pick a slot:",
        "ru": "Время окончания — выберите слот:",
        "el": "Ώρα λήξης — επιλέξτε χρονοθυρίδα:",
        "uk": "Час завершення — оберіть слот:",
    },
    "btn_skip": {
        "en": "Skip",
        "ru": "Пропустить",
    ...
    "step_title": {
        "en": "Step 5/6: *Event name?*",
        "ru": "Шаг 5/6: *Название события?*",
        "el": "Βήμα 5/6: *Όνομα εκδήλωσης;*",
        "uk": "Крок 5/6: *Назва події?*",
    },
    "ask_description": {
        "en": "📝 Describe your event\n\nWhat will people do there? Who is it for? Anything to bring or know in advance?\nKeep it short — people read on phones 📱",
        "ru": "📝 Опиши своё событие\n\nЧто будут делать участники? Для кого оно? Что нужно взять с собой или знать заранее?\nПиши коротко — люди читают с телефона 📱",
        "el": "📝 Περίγραψε την εκδήλωσή σου\n\nΤι θα κάνουν οι συμμετέχοντες; Για ποιους είναι; Τι να φέρουν μαζί τους;\nΓράψε σύντομα — οι άνθρωποι διαβάζουν από κινητό 📱",
        "uk": "📝 Опиши свою подію\n\nЩо робитимуть учасники? Для кого вона? Що потрібно взяти або знати заздалегідь?\nПиши коротко — люди читають з телефону 📱",
    },
    "ask_photo": {
    ...
    "share_announce": {
        "en": "Ready-made announcement for reposting:\n\n{text}\n\nCopy and send to your Telegram chat_",
        "ru": "Готовый анонс для репоста:\n\n{text}\n\nСкопируй и отправь в свой Telegram-чат_",
        "el": "Έτοιμη ανακοίνωση για αναδημοσίευση:\n\n{text}\n\nΑντίγραψε και στείλε στο Telegram chat σου_",
        "uk": "Готовий анонс для репосту:\n\n{text}\n\nСкопіюй та надішли у свій Telegram-чат_",
    },
    ...
    "card_no_reg": {
        "en": "No registration needed",
        "ru": "Регистрация не нужна",
        "el": "Δεν απαιτείται εγγραφή",
        "uk": "Реєстрація не потрібна",
    },
    "card_ask_organizer": {
        "en": "For registration contact organizer",
        "ru": "Для регистрации свяжитесь с организатором",
        "el": "Για εγγραφή επικοινωνήστε με τον διοργανωτή",
        "uk": "Для реєстрації зв'яжіться з організатором",
    },
    "card_lang_label": {
        "en": "Lang",
        "ru": "Язык",
    ...
    "step_preview": {
        "en": "*Preview* (updated)",
        "ru": "*Превью* (обновлено)",
        "el": "*Προεπισκόπηση* (ενημερώθηκε)",
        "uk": "*Перегляд* (оновлено)",
    },
    "preview_ok": {
