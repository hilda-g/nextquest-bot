...
STRINGS = {
    ...
    "welcome": {
        "en": "👋 Welcome to *NextQuest* — Cyprus Geek Events!\nDiscover events. Meet like-minded people. Host your own game nights!\n\n🎪 *Want to host an event?* Choose the *Organizer* role. Whether it's a big convention or a cozy game night — we'd love to feature it.\n\n🎲 *Looking for events?* Choose the *Participant* role. Discover what's happening nearby, subscribe to your favourite topics and organizers.\n\n💡 _You can always switch roles via the /start menu._",
        "ru": "👋 Добро пожаловать в *NextQuest* — гик-события Кипра!\nНаходи события. Знакомься с единомышленниками. Проводи свои игровые вечера!\n\n🎪 *Хочешь провести событие?* Выбери роль *Организатора*. Большой конвент или уютный игровой вечер — мы рады добавить любое.\n\n🎲 *Ищешь события?* Выбери роль *Участника*. Узнавай что происходит рядом, подписывайся на любимые темы и организаторов.\n\n💡 _Роль всегда можно сменить через меню /start._",
        "el": "👋 Καλώς ήρθες στο *NextQuest* — Geek εκδηλώσεις στην Κύπρο!\nΑνακάλυψε εκδηλώσεις. Γνώρισε ομοϊδεάτες. Διοργάνωσε τις δικές σου βραδιές παιχνιδιών!\n\n🎪 *Θέλεις να διοργανώσεις εκδήλωση;* Επίλεξε τον ρόλο *Διοργανωτή*. Μεγάλο συνέδριο ή φιλική βραδιά — χαρούμαστε να το προσθέσουμε.\n\n🎲 *Ψάχνεις εκδηλώσεις;* Επίλεξε τον ρόλο *Συμμετέχοντα*. Ανακάλυψε τι γίνεται κοντά σου, κάνε εγγραφή στα αγαπημένα σου θέματα και διοργανωτές.\n\n💡 _Μπορείς πάντα να αλλάξεις ρόλο μέσω του μενού /start._",
        "uk": "👋 Ласкаво просимо до *NextQuest* — гік-події Кіпру!\nЗнаходь події. Знайомся з однодумцями. Проводь власні ігрові вечори!\n\n🎪 *Хочеш провести подію?* Обери роль *Організатора*. Великий конвент чи затишний ігровий вечір — ми раді додати будь-яке.\n\n🎲 *Шукаєш події?* Обери роль *Учасника*. Дізнавайся що відбувається поруч, підписуйся на улюблені теми та організаторів.\n\n💡 _Роль завжди можна змінити через меню /start._",
    },
    "who_are_you": {
        "en": "Who are you?",
        "ru": "Кто ты?",
    ...
    "ask_limit": {
        "en": "👥 *How many people can join?*\n\n_Shown on the event card. You can close registration manually at any time._",
        "ru": "👥 *Сколько человек может участвовать?*\n\n_Отображается на карточке события. Закрыть регистрацию можно вручную в любой момент._",
        "el": "👥 *Πόσα άτομα μπορούν να συμμετάσχουν;*\n\n_Εμφανίζεται στην κάρτα εκδήλωσης. Μπορείς να κλείσεις τις εγγραφές χειροκίνητα ανά πάσα στιγμή._",
        "uk": "👥 *Скільки людей може взяти участь?*\n\n_Відображається на картці події. Закрити реєстрацію можна вручну будь-коли._",
    },
    "btn_no_limit": {
        "en": "No limit",
        "ru": "Без лимита",
    ...
    "ask_description": {
        "en": "📝 *Describe your event*\n\n_What will people do there? Who is it for? Anything to bring or know in advance?_\n_Keep it short — people read on phones_ 📱",
        "ru": "📝 *Опиши своё событие*\n\n_Что будут делать участники? Для кого оно? Что нужно взять с собой или знать заранее?_\n_Пиши коротко — люди читают с телефона_ 📱",
        "el": "📝 *Περίγραψε την εκδήλωσή σου*\n\n_Τι θα κάνουν οι συμμετέχοντες; Για ποιους είναι; Τι να φέρουν μαζί τους;_\n_Γράψε σύντομα — οι άνθρωποι διαβάζουν από κινητό_ 📱",
        "uk": "📝 *Опиши свою подію*\n\n_Що робитимуть учасники? Для кого вона? Що потрібно взяти або знати заздалегідь?_\n_Пиши коротко — люди читають з телефону_ 📱",
    },
    "ask_photo": {
